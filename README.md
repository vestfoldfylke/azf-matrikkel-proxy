...
| MATRIKKELAPI_IGNORE_EIERFORHOLD | Comma separated list of eierforhold types to ignore | JuridiskPersonSkattRegistrertEierforhold,SkattRegistrertEierforhold |
